...
public class FishingLine : MonoBehaviour
{
    ...
    float currentLength;
    public float CurrentLength => currentLength; // expose read-only
    ...
    // delta: linear change to length (negative = reel in)
    public void ApplySpoolDelta(float delta)
    {
        ...
        // only apply pull if there's an actual inward change
